...
export default function DetailsCard({ pet, status }) {
    const {
        image,
        petName,
        species,
        ...
        <Card className=" mx-auto rounded-3xl shadow-2xl border border-default-200">
            <div className="flex flex-col md:flex-row gap-2">
                ...
                <Card.Content className="">
                    {/* Heading */}
                    <div>
                        <h1 className="text-4xl font-extrabold">{petName}</h1>

                        <p className="text-default-500 text-lg mt-1">{breed}</p>
                    </div>
